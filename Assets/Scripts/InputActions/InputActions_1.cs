...
//     version 1.14.2
//     from Assets/Scripts/InputActions/InputActions_1.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Scripts/InputActions/InputActions_1.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputActions_1: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""c9d8e5f0-1a2b-3c4d-5e6f-7a8b9c0d1e2f"",
            ""actions"": [
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a5b6c7d8-e9f0-1a2b-3c4d-5e6f7a8b9c0e"",
    ...
    ~@InputActions_1()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, InputActions_1.Player.Disable() has not been called.");
    }
